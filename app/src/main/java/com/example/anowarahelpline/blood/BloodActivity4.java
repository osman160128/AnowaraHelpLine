...
public class BloodActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences("BloodSharedPref4", MODE_PRIVATE);

        boolean alreadyShows = sharedPreferences.getBoolean("is already shows", false);

        if(alreadyShows){
            Intent intent = new Intent(BloodActivity4.this,BloodLoginActivity.class);
